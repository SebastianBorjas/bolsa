    ...
    <body class="flex min-h-screen flex-col bg-white text-slate-900 font-sans">
        ...
        <main class="flex flex-1 flex-col pt-20 pb-16 space-y-8">
            <section class="mx-auto w-full max-w-6xl px-6 space-y-6">
                <div class="relative overflow-hidden rounded-3xl border border-slate-500 bg-slate-50/90 text-slate-900 shadow-[0_30px_120px_-20px_rgba(15,23,42,0.8)]">
            ...
            <section class="mx-auto w-full max-w-6xl px-6">
                <div class="relative -mt-6 overflow-hidden rounded-3xl border border-slate-500 bg-slate-50/90 text-slate-900 shadow-[0_30px_120px_-20px_rgba(15,23,42,0.8)]">
